  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={setRefs}
        className={cn(
          'fixed left-[50%] top-[50%] z-50 grid max-h-[85vh] w-[calc(100%-1.5rem)] max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto rounded-sheet border bg-background p-5 shadow-overlay duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:p-6',
          sheetBelowMdContentClass,
          className,
        )}
        {...props}
