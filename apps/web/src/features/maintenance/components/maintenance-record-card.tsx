...
export function MaintenanceRecordCard({
  ...
  return (
    <div className="group relative flex items-center gap-4">
      ...
      <Card className="@container flex-1 overflow-hidden border-slate-200/60 bg-white/70 shadow-premium-sm transition-all duration-300 hover:border-primary/20 hover:bg-white hover:shadow-premium-md">
        <Link
