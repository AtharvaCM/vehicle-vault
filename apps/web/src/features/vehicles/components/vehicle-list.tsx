        ...
        return (
          <VehicleCard
            ...
            selectionControl={
              onSelectionChange ? (
                <label
                  className="flex items-center justify-center rounded-md border border-border/70 bg-surface p-2 shadow-xs"
                  onClick={(event) => {
                ...
                >
                  <input
                    ...
                    checked={isSelected}
                    className={cn('h-4 w-4 rounded border-line text-fg focus:ring-ring')}
