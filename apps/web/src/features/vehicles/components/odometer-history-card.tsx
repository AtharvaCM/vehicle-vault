    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        {insights.history.length > 1 ? (
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <p className="text-ui font-semibold text-fg">{entry.label}</p>
                    {entry.kind === 'current' ? (
                  ...
                  <p className="text-caption text-muted-foreground">{format.date(entry.date)}</p>
                </div>
                <div className="space-y-1 text-right">
                  <p className="text-ui font-semibold text-fg">{format.odometer(entry.odometer)}</p>
          ...
          <div className="rounded-xl border border-dashed border-border/80 bg-page/70 px-4 py-6 text-ui text-muted-foreground">
        ...
        <div className="flex items-start gap-3 rounded-xl border border-border/70 bg-surface px-4 py-3">
          ...
          <div className="space-y-1">
            <p className="text-ui font-semibold text-fg">Why this matters</p>
