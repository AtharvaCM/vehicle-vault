        ...
        <div className="flex items-center justify-between border-t border-slate-100 bg-slate-50/30 p-4 md:border-l md:border-t-0 md:bg-transparent md:px-6 md:py-0">
          <div className="flex items-center gap-8 md:gap-10">
            <div className="space-y-0.5">
              ...
              <p className="text-[13px] font-semibold tabular-nums text-slate-700">{log.odometer.toLocaleString('en-IN')} km</p>
            </div>

            <div className="space-y-0.5">
              <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Price/L</p>
              <p className="text-[13px] font-semibold tabular-nums text-slate-700">{formatCurrency(log.price)}</p>
            </div>
            
            <div className="space-y-0.5">
              <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Total Cost</p>
              <p className="text-[13px] font-bold tabular-nums text-primary">{formatCurrency(log.totalCost)}</p>
            </div>
          </div>
